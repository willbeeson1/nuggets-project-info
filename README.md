...
* Your team will follow the [Scrum](https://github.com/CS50spring2023/home/blob/main/knowledge/units/scrum.md) style of project management.
...
* Your team shall follow the [Git Flow](https://github.com/CS50spring2023/home/blob/main/knowledge/units/git-flow.md) model of development.
* Good design, good style, good documentation, and good testing are expected.
* Consider the [characteristics of a successful team](https://github.com/CS50spring2023/home/blob/main/activities/activity7/README.md).
...
One member should **immediately** configure your repo to [protect the main branch](https://github.com/CS50spring2023/home/blob/main/knowledge/units/protect-main.md).
All members of the team should then clone the team's new repository, which includes the starter kit.

## Submissions

*[Deadlines](https://github.com/CS50spring2023/home/blob/main/logistics/syllabus.md#schedule) are provided in the syllabus.*
...
Recall the lecture unit about Design; it has a section about [design specs](https://github.com/CS50spring2023/home/blob/main/knowledge/units/design.md#design-spec).
...
Before the deadline, [push a branch called 'submit-design'](https://github.com/CS50spring2023/home/blob/main/logistics/submit.md).
...
Recall the lecture unit about Design; it has a section about [Implementation specs](https://github.com/CS50spring2023/home/blob/main/knowledge/units/design.md#implementation-spec).
...
Your spec may include diagrams; be sure to commit them.
Before the deadline, [push a branch called 'submit-implementation'](https://github.com/CS50spring2023/home/blob/main/logistics/submit.md).
*Make sure your Markdown renders properly on GitHub!*
...
Before the deadline, [push a branch called 'submit-final'](https://github.com/CS50spring2023/home/blob/main/logistics/submit.md).
...
How will you be sure to always have a clean, tested, runnable, 
submittable, `main` branch? Use git-flow!
...
Review the [unit](https://github.com/CS50spring2023/home/blob/main/knowledge/units/cohesion.md) about *cohesion* and *coupling*, and think about the content and role of each function you write.
...
* Follow [CS50 style guidelines](https://github.com/CS50spring2023/home/blob/main/logistics/style.md), including naming conventions.
* Use a consistent naming scheme: choose function and variable names that follow a consistent pattern, recalling the naming tips from a [recent unit](https://github.com/CS50spring2023/home/blob/main/knowledge/units/cohesion.md#routines).
...
In the [unit](https://github.com/CS50spring2023/home/blob/main/knowledge/units/cohesion.md) about *cohesion* and *coupling*, we noted that global *variables* are a bad form of coupling.
...
The client shall use the *ncurses* library to arrange its interactive display; see the [unit about ncurses](https://github.com/CS50spring2023/home/blob/main/knowledge/units/ncurses.md).
Note:
...
See the [unit](https://github.com/CS50spring2023/home/blob/main/knowledge/units/random.md) about random numbers.
...
All modern computers use the [ASCII standard code](https://www.rapidtables.com/code/text/ascii-table.html) for encoding common characters.
...
See the [unit](https://github.com/CS50spring2023/home/blob/main/knowledge/units/c-flow.md#switch) about the `switch` statement, which is particularly useful when you have a long list of cases that can be described by a simple comparison.
For example,
...
You may run your `client` or `server` on any Linux server in the [Thayer collection](https://github.com/CS50spring2023/home/blob/main/logistics/systems.md#linux), simply by giving the server's hostname on the client's commandline.
